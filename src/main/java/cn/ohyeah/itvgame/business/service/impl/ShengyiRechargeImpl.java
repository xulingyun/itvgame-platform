...
public class ShengyiRechargeImpl implements IRecharge {
	private static final Log log = LogFactory.getLog(ShengyiRechargeImpl.class);
	...
	static  {
		...
		amountUnit = Configuration.getAmountUnit("shengyi");
		cashToAmountRatio = Configuration.getCashToAmountRatio("shengyi");
	}
