...
public class MysqlAccountPermissionDaoImpl implements IAccountPermissionDao {
	...
	public void save(AccountPermission ap) {
		QueryHelper.update("insert into AccountPermission(accountId, daySubscribeLimit, " +
				...
				ap.getLastSubscribeTime(), ap.getDaySubscribeAmount(),
				ap.getMonthSubscribeAmount(), ap.getTotalSubscribeAmount(),
