...
<div style="position:absolute;left:0px;top:0px;width:634px;height:520px;background-image:url('../../content/product/worldwar/recharge.jpg');background-repeat:no-repeat;">
	...
	<c:choose>
		<c:when test="${empty rechargeRecord}">
			<tr height="40"><td>
				<div style="color:#01dfe4;left: 85px; top: 152px; width: 160px; height: 22px; position: absolute">无充值记录	</div>
			</td></tr>
		</c:when>
		<c:otherwise>
			<c:forEach items="${rechargeRecord}" var="item" varStatus="vs">
				<tr height="40">
				<td>
					<div style="color:#01dfe4;left: 122px; top: ${vs.index*30+152}px; width: 160px; height: 22px; position: absolute">
					${fn:substring(item.time, 0, 16) }
					</div>
					<div style="color:#01dfe4;left: 465px; top: ${vs.index*30+152}px; height: 22px; position: absolute">
