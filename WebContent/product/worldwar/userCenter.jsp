...
<div style="position:absolute;left:0px;top:0px;width:634px;height:520px;background-image:url('../../content/product/worldwar/userCenter.jpg');background-repeat:no-repeat;">
<table>
	<tbody>
	<!--<tr>
		<td>
	...
	--><tr>
		<td>
			<div style="left:160px;top:165px;position:absolute">
			<a href="recharge.jsp?productId=<%=productId %>&accountId=<%=accountId %>&userId=<%=userId %>&goldCoin=<%=goldCoin %>&returnUrl=<%=backUrl%>">
			<img width="327" height="85" src="../../content/common/empty.gif" border="0"/></a>
			</div>
			<div style="left:160px;top:285px;position:absolute">
