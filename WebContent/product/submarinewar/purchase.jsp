...
<div style="position:absolute;left:0px;top:0px;width:634px;height:520px;background-image:url('../../content/product/submarinewar/purchase.jpg');background-repeat:no-repeat;">
	...
	<c:choose>
		<c:when test="${empty purchaseRecord}">
			<tr height="40"><td>
	 		<div style="color:#01dfe4;left: 64px; top: 184px; width: 160px; height: 22px; position: absolute">无消费记录</div>
	 		</td></tr>
		</c:when>
		<c:otherwise>
			<c:forEach items="${purchaseRecord}" var="item" varStatus="vs">
				<tr height="40">
				<td>
					<div style="color:#01dfe4; left:44px; top: ${vs.index*27+183}px; width: 160px; height: 22px; position: absolute">
					${fn:substring(item.time, 0, 16) }
					</div>
				</td>
				<td>
					<div style="color:#01dfe4; left:189px; top: ${vs.index*27+183}px; width: 118px; height: 22px; position: absolute">
					${item.propName}
					</div>
				</td>
				<td>
					<div style="color:#01dfe4; left:325px; top: ${vs.index*27+183}px; height: 22px; position: absolute">
