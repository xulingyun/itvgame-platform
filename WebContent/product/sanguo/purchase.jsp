...
<div style="position:absolute;left:0px;top:0px;width:634px;height:520px;background-image:url('../../content/product/sanguo/purchase.jpg');background-repeat:no-repeat;">
	...
	<c:choose>
		<c:when test="${empty purchaseRecord}">
			<tr height="40"><td>
	 		<div style="color:#ffffff;left: 82px; top: 218px; width: 160px; height: 22px; position: absolute">无消费记录</div>
	 		</td></tr>
		</c:when>
		<c:otherwise>
			<c:forEach items="${purchaseRecord}" var="item" varStatus="vs">
				...
				<td>
					<div style="color:#ffffff; left:296px; top: ${vs.index*40+218}px; width: 118px; height: 22px; position: absolute">
					${item.propName}
					</div>
				</td>
				<td>
					<div style="color:#ffffff; left:492px; top: ${vs.index*40+218}px; height: 22px; position: absolute">
