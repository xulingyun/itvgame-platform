...
<div style="position:absolute;left:0px;top:0px;width:634px;height:520px;background-image:url('../../content/product/sanguo/ranking.jpg');background-repeat:no-repeat;">
		<table>
		<%
		...
		%>
		   <tr height="30">
		   	  <td>
		         <div style="left:52px;top:<%=i*30+140 %>px;height:24px;position:absolute;color:#ffffff;">
		      ...
		      <td>
		         <div style="left:118px;top:<%=i*30+140 %>px;height:24px;position:absolute;color:#ffffff;">
		           <%=formatUserId(gameRank.getUserId()) %>
		         </div>
		      </td>
		      <td>
		         <div style="left:230px;top:<%=i*30+140 %>px;height:24px;position:absolute;color:#ffffff;">
		           <%=gameRank.getScores() %>
		         </div>
		      </td>
		       <td>
		         <div style="left:348px;top:<%=i*30+140 %>px;height:24px;position:absolute;color:#ffffff;">
		           <%=StringUtils.substringBefore(gameRank.getRemark(), ";") %>
		         </div>
		      </td>
		       <td>
		         <div style="left:456px;top:<%=i*30+140 %>px;height:24px;position:absolute;color:#ffffff;">
		           <%=DateFormatUtils.format(gameRank.getTime(), "yyyy-MM-dd HH:mm") %>
		         </div>
		      </td>
		   </tr>
	  <%
	  ...
	  %> 
		...
		<span style="left:192px;top:459px;position:absolute;width:98px;height:33px;font-size:20px;color:#FF00FF;text-align:center"><%=userRank %></span>
